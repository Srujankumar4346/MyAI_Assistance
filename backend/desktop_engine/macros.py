...
class MacroEngine:
    ...
    def save_macro(self, db: Session, user_id: int, name: str, trigger: str, steps: list) -> AutomationMacro:
    ...
    def execute_macro(self, db: Session, user_id: int, macro_id: str, pipeline_instance, context: dict):
