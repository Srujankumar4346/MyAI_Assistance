...
class DownloadManager:
    ...
    async def handle_download(self, db: Session, user_id: int, download_obj) -> str:
        ...
        # Determine file type
        file_ext = suggested_filename.split(".")[-1].lower() if "." in suggested_filename else "unknown"
        ...
        # Telemetry
        log_telemetry("download_completed", {"file_type": file_ext, "file_size": metadata["file_size"]})
